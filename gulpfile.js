...
gulp.task('inject', gulp.parallel('inject:head', 'inject:footer', 'inject:tagpage', 'inject:blog'));

// 'gulp build:site' -- copies, builds, and then copies it again
gulp.task('build:site', gulp.series('site:tmp', 'inject', 'site', 'copy:site', 'copy:redirects'));
