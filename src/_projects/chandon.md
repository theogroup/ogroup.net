...
image: /uploads/chandon-featured-image.png
vimeo_id:
vimeo_width:
vimeo_height:
...
content_blocks:
  ...
  - text_banner:
      ...
      text_banner_background_color:
    image_banner:
      image_banner_image: /uploads/chandon-image-banner-1.png
      image_banner_text_color:
      image_banner_text: 'A fun poppy illustration, festive colors, and playful typography create an irreverant, celebratory mood perfect for the holiday season.'
    split_banner:
      split_banner_image:
      image_align:
      split_banner_headline_line_1:
  ...
  - text_banner:
    ...
    gallery_images:
      - image_path:
    grid_image:
      grid_image_image: /uploads/chandon-grid-image-1.png
  - text_banner:
      text_banner_text:
      text_banner_color:
      text_banner_background_color:
    ...
    gallery_images:
      - image_path:
    grid_image:
      grid_image_image: /uploads/chandon-grid-image-2.png
  - text_banner:
      text_banner_text: 'A playful, chic holiday bottle with an emphasis on style, recasts and reinterprets sparkling wine category traditions.'
      text_banner_color: '#212121'
      text_banner_background_color: '#a3ded2'
    image_banner:
      image_banner_image:
  ...
  - text_banner:
    ...
    gallery_images:
      - image_path:
    grid_image:
      grid_image_image: /uploads/chandon-grid-image-3.png
